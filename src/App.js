...
const [selectedweapon,setselectedweapon]=useState({})
 const[myhealthpoints,setmyhealthpoints]=useState(0)
  const[enemyhealthpoints,setenemyhealthpoints]=useState(0)


  return (
    <mainContext.Provider value={{getrace,setrace,getinventory,setinventory,characters,monsters,dropItems,trader,selectedweapon,setselectedweapon,myhealthpoints,setmyhealthpoints,enemyhealthpoints,setenemyhealthpoints}}>
    <div className='App'>

<BrowserRouter>
{getrace.race &&<Toolbar/>}
